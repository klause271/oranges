...
#define TASK_MM		4
#define TASK_LOG	5
#define TASK_FLUSH  6  // 新增日志刷新任务
#define INIT		7  // 原有INIT序号后移		  
...
enum msgtype {
	...
	/* SYS task */
	GET_TICKS, GET_PID, GET_RTC_TIME, XIA, GET_PROC_INFO, OK, KILL_PROC, ERROR,

	/* FS */
	OPEN, CLOSE, READ, WRITE, LSEEK, STAT, UNLINK, SEARCH, KILL,
